  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-purple-100 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto bg-white rounded-xl shadow-2xl p-8">
        ...
        <h1 className="text-4xl font-bold text-indigo-900 mb-6 text-center">{campaign.title}</h1>
        ...
        <div className="mb-8 bg-gradient-to-r from-indigo-50 to-purple-50 p-6 rounded-xl shadow-md">
          ...
          <div className="flex flex-wrap gap-4">
            <DetailCard title="Action" value={campaign.action} icon={Zap} color="bg-blue-50 text-blue-800" />
            <DetailCard title="Reward" value={campaign.reward} icon={Award} color="bg-green-50 text-green-800" />
          </div>
        </div>

        <div className="mb-8 bg-gradient-to-r from-indigo-50 to-purple-50 p-6 rounded-xl shadow-md">
          <h2 className="text-2xl font-semibold text-gray-800 mb-4">Action Data</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <DetailCard title="Platform" value="Jupiter" icon={ExternalLink} color="bg-indigo-50 text-indigo-800" />
            <DetailCard title="Token to Swap" value="SOL" icon={ExternalLink} color="bg-purple-50 text-purple-800" />
            <DetailCard title="Min Amount" value="0.1 SOL" icon={ExternalLink} color="bg-pink-50 text-pink-800" />
          </div>
        </div>
          ...
          <div className="flex flex-wrap gap-4">
            {recentParticipants.map((participant, index) => (
              <div key={index} className="flex flex-col items-center">
                ...
                />
                <span className="text-sm text-gray-600 mt-2">{participant.address}</span>
              </div>
            ))}
          </div>
        </div>
